...
import 'package:vpnchik/core/router/adaptive_layout/shell_route_action.dart';
import 'package:vpnchik/core/router/go_router/helper/active_breakpoint_notifier.dart';
import 'package:vpnchik/core/router/go_router/routing_config_notifier.dart';
import 'package:vpnchik/features/stats/widget/side_bar_stats_overview.dart';
...
class MyAdaptiveLayout extends HookConsumerWidget {
  ...
  List<ShellRouteAction> _actions(Translations t, bool showProfilesAction, bool isMobileBreakpoint) => [
    ShellRouteAction(Icons.edit_note_rounded, t.pages.home.title),
    if (showProfilesAction && !isMobileBreakpoint) ShellRouteAction(Icons.view_list_rounded, t.pages.profiles.title),
    ShellRouteAction(Icons.settings_suggest_rounded, t.pages.settings.title),
